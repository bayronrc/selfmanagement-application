...
export default function HistorialRipsPage() {
    ...
    <div className="p-6 space-y-6 pt-2">
      <div className="flex items-center justify-between">
        ...
        <Link href="/rips/registrar">
          <Button size="sm" className="bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white shadow-lg shadow-blue-500/20 gap-2">
